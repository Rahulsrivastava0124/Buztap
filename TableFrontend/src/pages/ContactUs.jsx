      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-24 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <p className="text-[#857c6e] text-lg mb-12 max-w-lg leading-relaxed">
            Whether you have a question about features, pricing, or need a custom enterprise plan, our team is ready to answer all your questions.
          </p>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#857c6e] mb-1">Come say hello at our office HQ.</p>
                <p className="font-medium text-[#2a2720]">100 Tech Park, Building A<br/>Koramangala, Bangalore 560034</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+919876543210" className="font-semibold text-[#e8720c] hover:underline">+91 98765 43210</a>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          {isSubmitted ? (
            ...
            >
              ...
              <h2 className="text-3xl font-display font-bold text-[#0f0e0b] mb-4">Message Sent!</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative relative z-10">
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="name" className="block text-sm font-bold text-[#2a2720] mb-2">First Name</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-bold text-[#2a2720] mb-2">Email Address</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-bold text-[#2a2720] mb-2">Subject</label>
                <input
                  type="text"
                  id="subject"
                  name="subject"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-bold text-[#2a2720] mb-2">Message</label>
                <textarea
                  id="message"
                  name="message"
